...
mkdir -p /gladstone/bioinformatics/projects/mn-1318-maxine-nelson-yadong-huang-snrnaseq-mm10-aug-2022/results/data/07_de_genes_no_S521G/
...
singularity exec $container_dir/gb_mn_1318_r_seurat4_harmony.sif Rscript $script_dir/src/07_de_genes_no_S521G.R
