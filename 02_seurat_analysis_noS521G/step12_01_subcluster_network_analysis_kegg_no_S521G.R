...
setwd(indir)
outdir_astro <- "../12_01_subclusters_KEGG_enriched_pathways_no_S521G/astrocyte/"
outdir_micro <- "../12_01_subclusters_KEGG_enriched_pathways_no_S521G/microglia/"
...
writeLines(capture.output(sessionInfo()), 
           paste0("../12_01_subclusters_KEGG_enriched_pathways_no_S521G/",
                  "sessionInfo.txt"))
