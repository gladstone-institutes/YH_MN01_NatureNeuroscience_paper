...
pdf(file = file.path(outdir, 
                     paste0("plot/02_clustering_no_S521G/",
                            "cluster_sct_data_no_S521G", 
                            "_PCA_plots.pdf")),
    width = 12,
    height = 7)
...
marker_genes_matrix <- read.csv(paste0("/gladstone/bioinformatics/projects/",
...
write.csv(MarkersRes,
          file = file.path(outdir, 
                           paste0("data/02_clustering_no_S521G/",
