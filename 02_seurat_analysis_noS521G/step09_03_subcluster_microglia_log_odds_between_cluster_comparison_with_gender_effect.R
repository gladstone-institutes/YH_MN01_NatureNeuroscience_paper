...
outdir <- paste0(basedir, 
                 "09_subclusters_log_odds_calculation/microglia_with_gender_effect/")
...
write.csv(ClusterRes, 
          file = "log_odds_ratio_with_gender_effect_per_genotype_per_microglia_subcluster.csv")
...
pdf("log_odds_boxplot_with_gender_effect_microglia_subcluster_with_padj.pdf",
    height = 20,
    width = 35
)
...
pdf("log_odds_boxplot_with_gender_effect_microglia_subcluster_with_pvalue_and_padj.pdf",
    height = 20,
    width = 35
)
ggplot(ClusterRes_plot, 
