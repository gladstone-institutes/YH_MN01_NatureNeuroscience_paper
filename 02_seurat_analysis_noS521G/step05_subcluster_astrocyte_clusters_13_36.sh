...
mkdir -p /gladstone/bioinformatics/projects/mn-1318-maxine-nelson-yadong-huang-snrnaseq-mm10-aug-2022/results/data/05_subcluster_astrocyte_clusters_13_36/
mkdir -p /gladstone/bioinformatics/projects/mn-1318-maxine-nelson-yadong-huang-snrnaseq-mm10-aug-2022/results/plot/05_subcluster_astrocyte_clusters_13_36/
...
singularity exec $container_dir/gb_mn_1318_r_seurat4_harmony.sif Rscript $script_dir/src/05_subcluster_astrocyte_clusters_13_36.R
