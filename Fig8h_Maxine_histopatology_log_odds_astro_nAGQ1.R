...
print(ClusterRes)
write.csv(t(ClusterRes), file = paste0(outdir,"microglia_log_odds_ratio_per_unit_per_histopathology_per_cluster_by_sample.csv"))
...
histo_all<-read.csv(paste0(outdir,"microglia_log_odds_ratio_per_unit_per_histopathology_per_cluster_by_sample.csv"))
...
pdf(paste0(outdir,"Fig.ex8h_microglia_without_gender_effect_pathology_cl2_8_11.pdf"), height=6, width=12)
